...
Mouser	mouser.com/api-hub	MOUSER_API_KEY
Digi-Key	developer.digikey.com	DIGIKEY_CLIENT_ID + DIGIKEY_CLIENT_SECRET
Farnell	partner.element14.com	FARNELL_API_KEY
All keys are free — just register as a developer on each platform.

➕ Adding a New Distributor
Create src/lib/adapters/your-distributor.adapter.ts
Implement the DistributorAdapter interface (see adapter.interface.ts)
